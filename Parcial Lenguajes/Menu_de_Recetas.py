...
options_menu.add_command(label="View Recipe", command=ver_ingredientes)
options_menu.add_command(label="Delete Recipe", command=eliminar_receta)
options_menu.add_separator()
options_menu.add_command(label="Exit", command=salir)
